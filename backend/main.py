...
async def docs_redirect():
    return {"note": "FastAPI docs are available at /docs when proxied to backend"}
"""
main.py — QuerySafe FastAPI application entry point.
...
try:
    ...
    logger.warning("AI module not found — skipping ai routes (P1 module not yet integrated).")
